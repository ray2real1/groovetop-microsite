...
export default function ProblemGoal() {
  ...
  return (
    <section aria-labelledby="problem-heading" className="py-section bg-groovetop-oat">
      <div className="max-w-content mx-auto px-6 lg:px-10">
        ...
        >
          <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-groovetop-terracotta">Problem + Goal</p>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 id="problem-heading" className="text-xs font-bold tracking-[0.15em] uppercase text-white/40">The Problem</h2>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 id="goal-heading" className="text-xs font-bold tracking-[0.15em] uppercase text-groovetop-navy/40">The Goal</h3>
            </div>
            ...
            <div className="pt-4 space-y-2.5 border-t border-groovetop-navy/8">
              <p className="text-[10px] font-bold tracking-[0.15em] uppercase text-groovetop-navy/35 mb-3">Primary Flows</p>
              {FLOWS.map((flow) => (
