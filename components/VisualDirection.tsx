...
const PALETTE = [
  {
    ...
    hex:     "#1B2A4A",
    token:   "Global Navy",
    role:    "Trust, structure, text",
    textColor: "text-white",
  },
  {
    name:    "Terracotta",
    hex:     "#C96F53",
    token:   "Global Terracotta",
    role:    "Warmth, CTAs, accents",
    textColor: "text-white",
  },
  {
    name:    "Oat Cream",
    hex:     "#FAF7F1",
    token:   "Global Oat",
    role:    "Calm background surfaces",
    textColor: "text-groovetop-navy",
    border:  true,
  },
  {
    name:    "White",
  ...
  },
  {
    name:    "Success Green",
    hex:     "#2EAD8C",
    token:   "Global Success",
    role:    "Availability, positive states",
    textColor: "text-white",
  },
  {
    name:    "Interactive Blue",
    hex:     "#618FED",
    token:   "Global Interactive",
    role:    "Secondary links, focus states",
    textColor: "text-white",
  },
];
        ...
        <div className="grid lg:grid-cols-[1fr_1fr] gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <div className="p-5 rounded-2xl bg-groovetop-oat border border-groovetop-navy/8 space-y-2">
              <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-groovetop-navy/35">
            ...
            {PALETTE.map((color, i) => (
              ...
              >
                ...
                <div
                  ...
                  aria-hidden="true"
                >
                  <span className={`text-[9px] font-mono font-bold ${color.textColor} opacity-70`}>
                    {color.hex}
                  </span>
                </div>
                {/* Label */}
